...
MERGE_TRAIN_CLASS_LABELS = ('angry', 'calm', 'disgust', 'fear', 'happy', 'neutral', 'sad', 'surprise')#MERGE TRAIN
MERGE_TEST_CLASS_LABELS = ('angry', 'calm', 'disgust', 'fear', 'happy', 'neutral', 'sad', 'surprise')#MERGE TEST
CLASS_LABELS_dict = {"CASIA": CASIA_CLASS_LABELS,
               ...
               "MERGE_TRAIN": MERGE_TRAIN_CLASS_LABELS,
               "MERGE_TEST": MERGE_TEST_CLASS_LABELS,}
...
elif args.mode=='test_cus':
    x_feats, y_labels = model.test_cus(x_source, y_source, path=args.test_path) # x_feats and y_labels are test datas for t-sne
